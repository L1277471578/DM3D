...
def parse_args():
    ...
    # parser.add_argument('--pretrain_weight', type=str, default=None, help='pre-weight')
    parser.add_argument('--pretrain_weight', type=str, default='ckpts/part_seg_pretrain.pth', help='pre-weight')
...
def main(args):
    ...
    if args.pretrain_weight:
        ...
        log_string('Load model from %s' % args.pretrain_weight)
    else:
    ...
    for epoch in range(start_epoch, args.epoch):
        ...
        '''learning one epoch'''
        for i, (points, label, target) in tqdm(enumerate(trainDataLoader), desc='Training', total=len(trainDataLoader), smoothing=0.9):
            optimizer.zero_grad()
